## This script creates the histogram for plot1.png of the Exploring Data Project 1 assignment. Author David Garza
## 2016.12.12.
...
plot1 <- function() {
  ...
  png("plot1.png")
  hist(february$Global_active_power, main = "Global Active Power", xlab = "Global Active Power", col = "red")
  dev.off()
