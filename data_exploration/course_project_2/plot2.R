# This is the second plot for the second course project in data explroation. Author David C Garza 01/07/2017
...
plot2 <- function() {
  ...
  plot(names(total_per_year),total_per_year, xlab = "Year", ylab = "PM 2.5 Emissions (Tons)", main ="Baltimore Total Yearly PM 2.5 Emissions Trending Downward")
